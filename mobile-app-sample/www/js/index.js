var ENV = (function() {
    ...
    return {
        settings: {
            someSetting: localStorage.getItem('someSetting') || 'true'
        },
        toggle: function(key) {
    ...
    */
    ...
    configureBackgroundGeoLocation: function() {
        ...
        */
        ...
        /**
        * Geolocation recorded in background.
        */
        var backgroundCallback = function(location) {
        ...
        bgGeo.configure(backgroundCallback, failureFn, {
            desiredAccuracy: 0,
            stationaryRadius: 50,
            distanceFilter: 50,
            notificationTitle: 'Graffiti background process', //Android only
            notificationText: 'ENABLED', //Android only
        ...
        if (settings.enabled == 'true') {
            bgGeo.start(); //track in background
            //bgGeo.changePace(true);  //TODO what does this do?
        }
    },
